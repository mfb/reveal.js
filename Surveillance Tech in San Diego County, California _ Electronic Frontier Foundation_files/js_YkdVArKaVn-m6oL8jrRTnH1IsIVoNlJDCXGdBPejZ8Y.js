...
(function ($, Clipboard) {
  ...
  Drupal.behaviors.masthead = {
    attach: function (context, settings) {
      ...
      $('#masthead-wrapper', context).mouseleave(function () {
        ...
        $('.pane-main-nav-menu li.expanded').removeClass('expanded');
  ...
  Drupal.behaviors.longReadShareLinksCopy = {
    attach: function (context, settings) {
      if (Clipboard.isSupported()) {
        ...
        var item = $('.share-clipboard', context)[0];
        if (!item) {
          return;
        }
  ...
  Drupal.behaviors.readMore = {
    attach: function(context) {
      ...
      if (!more_button.length && $('body').hasClass('page-issues-l1')) {
  ...
  Drupal.behaviors.imageLinksTabIndex = {
    attach: function (context) {
      $('.views-field-content-thumbnail a', context).attr('tabindex', -1);
      $('.view .field--name-field-banner-graphic a', context).attr('tabindex', -1);
      $('.node--highlight .field--name-field-banner-graphic a', context).attr('tabindex', -1);
      $('.node--highlight header > a > img', context).parent().attr('tabindex', -1);
    }
  };
  ...
  Drupal.behaviors.torAndHttpsPage = {
    attach: function (context, settings) {
      if (!$('body').is('.page-node-96183')) {
        return;
      }
      ...
      function set_background() {
        ...
        $('#tor-https', context).css('background-image', 'url("/files/tor-https-' + image + '.png")');
      }

      set_background();

      $('#tor-https #tor', context).hover(function () {
        $(this).addClass('hover');
      }, function () {
        $(this).removeClass('hover');
      });

      $('#tor-https #https', context).hover(function () {
        $(this).addClass('hover');
      }, function () {
        $(this).removeClass('hover');
      });

      $('#tor-https #tor', context).click(function () {
        if (tor) {
          tor = false;
      ...
      $('#tor-https #https', context).click(function () {
        if (https) {
          https = false;
          $(this).removeClass('active');
        }
  ...
  Drupal.behaviors.dataTable = {
    attach: function(context, settings) {
      ...
      $('.large-table', context).each(function(tableIndex) {
        ...
        datatables[tableIndex] = {children: [], toggleable: {},
          startHidden: {}};
        ...
        if (currentTable.children.length > 0) {
          columns.push({targets: [0], className: 'details details-closed',
            orderable: false});
